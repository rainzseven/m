...
var kuhong = db.get('ojan'); // jan diubah
	...
	console.log('WELCOME TO RZ API!') // boleh diubah
}

var creatorList = ['Rainz ofc']; // Nama Lu Ngab
var creator = creatorList[Math.floor(Math.random() * creatorList.length)]; // Ini jan diubah
var key = 'Rztrial' // Apikey Lu Ngab
...
loghandler = {
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: `Apikey tidak ditemukan! Silahkan kontak Owner untuk dapatkan Apikey wa.me/62821298938997`
    },
    invalidLink: {
        status: false,
        creator: `${creator}`,
